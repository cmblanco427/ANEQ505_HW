...
-emmeans categorical, emtrends for continuous

-in alpha diversity- strict numerical count, can say inc or dec in diveristy, but beta diversity is 3-D, so can only see if more or less similiar, so use PC1s
...
```
- now talking about personal data
To get a bottom part of the image to show where lines fall in a horizontal boxplot, add a boxplot code to see. 
