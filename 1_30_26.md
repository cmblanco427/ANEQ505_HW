...
![Grumpy Cat has no Metadata: VITA Toolkit Help](https://images.ourontario.ca/Partners/ODW/ODW003582031.jpg)
...
`# make a directory for the metadata using the mkdir command while you are INSIDE of the decomp_tutorial directory   mkdir metadata`  
  
`# move into that directory using cd   cd metadata`  
